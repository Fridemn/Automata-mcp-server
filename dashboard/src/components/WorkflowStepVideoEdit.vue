<template>
  <div class="workflow-step-video-edit">
    <div class="flex flex-col gap-4">
      <button @click="handleEditVideo" :disabled="step.status === 'running'" class="px-4 py-2 bg-blue-500 text-white border-none rounded cursor-pointer transition-colors duration-200 hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed">
        开始视频剪辑
      </button>
    </div>
  </div>
