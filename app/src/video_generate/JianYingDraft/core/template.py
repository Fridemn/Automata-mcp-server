...
def get_speed(guid: str = None):
    ...
    return {"curve_speed": None, "id": guid, "mode": 0, "speed": 1.0, "type": "speed"}
...
def get_text(guid: str = None):
    ...
    return {
        ...
        "border_width": 0.08,
        "check_flag": 7,
        "content": '<font id="" path="E:/JianyingPro/4.2.0.10100/Resources/Font/SystemFont/zh-hans.ttf"><color=(1.000000, 1.000000, 1.000000, 1.000000)><size=50.000000>[默认文本]</size></color></font>',
        "font_category_id": "",
        "font_category_name": "",
        "font_id": "",
        "font_name": "",
...
def get_material_animation(guid: str = None):
    ...
    return {"animations": [], "id": guid, "type": "sticker_animation"}


def get_detail_animation(
    resource_id: str = "",
    name="",
...
def get_audio_fade(
    guid: str = None, fade_in_duration: int = 0, fade_out_duration: int = 0
):
    """
    添加音频的淡入淡出效果
    @param guid:
...
def get_transition(
    guid: str = None, resource_id: str = "", name="", duration: int = 500_000
):
    """
    添加视频特效
